...
function waitForListingPage() {
  try {
    ...
    const placeBidMessageMobile = document.querySelector(
      "#place-bid-message-mobile"
    );
    const placeBidMessageDesktop = document.querySelector(
      "#place-bid-message-desktop"
    );
